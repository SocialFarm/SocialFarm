# Django settings for fbbuis project.
...
DATABASE_NAME = '/home/smaldone/fbbuis/fbbuis.db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ker)#&-2hiv6tw-naz%d%aqzfb91^d#pj3^$540n6*gtxsyhx^'
