...
var Potato = function() {
    ...
    Renderer.prototype = {
        show: function(html, doc, req) {
		    ...
		    base.default_css = Mustache.to_html(html.common.default_css,doc);
		    base.default_js = Mustache.to_html(html.common.default_js,doc);
		    base.header = header;
        ...
        list: function(html, head, req) {
		    ...
		    base.meta_author = html.common.meta_author;
			base.default_css = Mustache.to_html(html.common.default_css,base);
		    base.default_js = Mustache.to_html(html.common.default_js,base);
		    base.header = header;
